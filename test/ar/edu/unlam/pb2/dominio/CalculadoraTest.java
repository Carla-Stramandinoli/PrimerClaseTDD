...
public class CalculadoraTest {
	...
	// sumar: dados dos valores debe devolver la suma de estos.
	// restar: dados dos valores debe devolver la resta de estos.
	// multiplicar: dados dos valores debe devolver la multiplicacion de estos.
	// dividir: dados dos valores debe devolver la division de estos. Si el
	...
	public void test() {
		...
		// objetivo. Instanciar variables, inicializar objetos, etc.

		// Ejecucion: invocacion al metodo que estamos probando.

		// Validacion: verificamos que lo devuelto por el metodo testeado sea correcto
		// con respecto a lo que debe ser.

		// Nota: Test debe dar rojo inicialmente. Luego agregamos el codigo productivo
	...
	public void dadoQueExisteUnaCalculadoraCuandoSumoLosValores3y4EntoncesObtengoComoResultado7() {
		...
		// Validacion: then - entonces se cumplen las validaciones.
		int valorEsperado = 7;
